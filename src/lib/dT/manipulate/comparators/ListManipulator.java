...
public final class ListManipulator {
      ...
      * this method compare each elements of List arguments using
        BiPredicate {@param sc}.
      * method use {@param sc} to compare all String elements of {@param o1} to the
        corresponding String element of {@param o2}.
      * returns {@code true}, if all the elements of {@param o1} is equals to
        the corresponding elements of {@param o2} using {@code BiPredicate}
        {@param sc}.<br>
      ...
      * this method create return new list containing String elements generated
        by applying trim operation on elements of List {@param li}.<br>
      * NOTE :- this method will not modify List of strings given in
        arguments. although copy of Original List as argument is recommended.<br>
        the List given in arguments should not be modify in parallel of this 
        method call by any other threads.
      ...
      * @return new list of string generated by removing preceding & trailing 
        whitespace of elements of {@param li}.
      */
      ...
      * return List of string generated concatenation of arrays of strings
        generated by applying split operation on all elements of List {@param li}.
